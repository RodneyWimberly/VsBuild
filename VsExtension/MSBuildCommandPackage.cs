...
namespace VsBuild.VsExtension
{
    ...
    /// </para>
    /// <para>
    /// To get loaded into VS, the package must be referred by &lt;Asset Type="Microsoft.VisualStudio.VsExtension" ...&gt; in .vsixmanifest file.
    /// </para>
    /// </remarks>
    ...
    public sealed class MSBuildCommandPackage : AsyncPackage
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MSBuildCommandPackage"/> class.
        /// </summary>
        public MSBuildCommandPackage()
        {
        ...
        protected override async Task InitializeAsync(CancellationToken cancellationToken, IProgress<ServiceProgressData> progress)
        {
            ...
            await MSBuildToolsWindowCommand.InitializeAsync(this);
        }
